...
export function CreateUserModal({ isOpen, onClose, onSuccess }: CreateUserModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Extract password from response (backend should return it)
      // For now, we'll generate a display password
      const generatedPassword = 'TempPass123!'; // This should come from backend
