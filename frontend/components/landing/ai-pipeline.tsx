  ...
  const steps = [
    {
      ...
      desc: 'Monthly case uploads and real-time climate telemetry',
      color: 'text-blue-500',
      bg: 'bg-blue-500/10',
      delay: 'delay-100',
    },
    {
      ...
      desc: 'Historical trends powering district-level risk predictions',
      color: 'text-primary',
      bg: 'bg-primary/10',
      delay: 'delay-300',
    },
    {
      ...
      desc: 'Response guidance and outbreak alerts for district teams',
