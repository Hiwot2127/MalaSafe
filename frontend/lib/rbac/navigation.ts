...
export const DASHBOARD_NAVIGATION: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        label: 'Monthly Malaria',
        href: '/dashboard/upload/monthly',
        icon: FileUp,
        description: 'Upload monthly malaria data',
        requiredPermissions: [Permission.UPLOAD_MONTHLY_MALARIA],
      },
      {
        label: 'Weekly Malaria',
        href: '/dashboard/upload/weekly',
        icon: Database,
        description: 'Upload weekly malaria data',
        requiredPermissions: [Permission.UPLOAD_WEEKLY_MALARIA],
      },
      {
        label: 'Climate Data',
        href: '/dashboard/upload/climate',
        icon: FileUp,
        description: 'Upload climate data',
        requiredPermissions: [Permission.UPLOAD_CLIMATE],
      },
    ],
  },
  {
